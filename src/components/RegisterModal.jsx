...
const RegisterModal = ({ registerData, onChange, onSubmit, onClose, switchToLogin, error }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50" aria-modal="true">
      <div className="bg-white dark:bg-gray-700 rounded-xl w-full max-w-md p-6 shadow-lg">
        ...
        <form onSubmit={onSubmit} className="mt-4 space-y-4">
          ...
          <button type="submit" className="w-full bg-blue-700 text-white py-2 rounded-lg">Register</button>

          <div className="relative text-center">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t" />
            </div>
            <div className="relative bg-white dark:bg-gray-700 px-4 text-gray-500 text-sm">or</div>
          </div>
          ...
          <p className="text-sm text-gray-500 text-center">
            ...
            <button type="button" onClick={switchToLogin} className="text-blue-600 underline">Login</button>
          </p>
        </form>
      </div>
    </div>
